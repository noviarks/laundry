                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control" id="uom" name="uom" required>
                                    <option value="" hidden>-- Choose UoM --</option>
                                    @foreach($data_uom as $uom)
                                    <option value="{{ $uom->id }}">{{ $uom->desc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                ...
                                <input id="price" type="number" min="0" name="price" class="form-control" placeholder="Fill Price" required>
                            </div>
                        </div>
                    </div>			
                </div>
...
@foreach($data_service as $row_update)
<div class="modal fade" id="modalUpdate{{ $row_update->id }}" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <form method="POST" action="/service/update/{{ $row_update->id }}">
                @csrf
                <div class="modal-body">				
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                <label>Desc</label>
                                <input id="desc" type="text" value="{{ $row_update->desc }}" name="desc" class="form-control" placeholder="Fill Desc" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control" id="uom" name="uom" required>
                                    @foreach($data_uom as $uom)
                                    <option value="{{ $uom->id }}" <?php if($uom->id == $row_update->uom_id) echo 'selected'; ?>>{{ $uom->desc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                <label>Price (Rp)</label>
                                <input id="price" type="number" min="0" value="{{ $row_update->price }}" name="price" class="form-control" placeholder="Fill Price" required>
                            </div>
                        </div>
                    </div>				
                </div>
...
@foreach($data_service as $row_delete)
<div class="modal fade" id="modalDelete{{ $row_delete->id }}" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <form method="GET" action="/service/delete/{{ $row_delete->id }}">
                @csrf
                <div class="modal-body">		
