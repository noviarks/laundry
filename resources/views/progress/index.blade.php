...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <form method="POST" action="/progress/store">
                @csrf
...
@foreach($data_progress as $row_update)
<div class="modal fade" id="modalUpdate{{ $row_update->id }}" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <form method="POST" action="/progress/update/{{ $row_update->id }}">
                @csrf
                <div class="modal-body">				
                    <div class="row">
                        <div class="col-sm-12">
...
@foreach($data_progress as $row_delete)
<div class="modal fade" id="modalDelete{{ $row_delete->id }}" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <form method="GET" action="/progress/delete/{{ $row_delete->id }}">
                @csrf
                <div class="modal-body">		
